...
function editClick(e) {
    ...
    if (typeof descr.savedText == 'undefined' && typeof name.savedText == 'undefined') {
        ...
        cancelBtn.onclick = () => {
            ...
            name.innerText = name.savedText;
            delete name.savedText;
        ...
        if (descr.savedText !== descr.innerText || name.savedText != name.innerText) {
            fetch(window.location.href, {
                method: "PUT",
                body: JSON.stringify({id: pid, description: descr.innerText, name: name.innerText}),
                headers: {
